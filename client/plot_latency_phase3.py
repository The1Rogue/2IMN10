...
PNG = pathlib.Path("/out/latency_phase3.png")
...
for c in range(5):
	...
	for batch in range(5):
		with pathlib.Path(f"/out/latency_phase3_{client}_{batch}.csv").open("r", encoding="utf-8") as file:
...
plt.title("Phase 3: Client-perceived execution latency per request")
plt.xlabel("Request #")
